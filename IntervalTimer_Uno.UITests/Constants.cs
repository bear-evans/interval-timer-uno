namespace IntervalTimer_Uno.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5001/";
    public readonly static string iOSAppName = "com.companyname.IntervalTimer_Uno";
    public readonly static string AndroidAppName = "com.companyname.IntervalTimer_Uno";
